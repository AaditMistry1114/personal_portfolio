...
import HeroParticlesBackground from '../backgrounds/HeroParticlesBackground';

export default function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center bg-black pt-24 lg:pt-0 px-4 sm:px-6 lg:px-8 overflow-hidden"
    >
      {/* Particles Background - z-0 ensures it's behind all content */}
      <div className="absolute inset-0 z-0">
        <HeroParticlesBackground />
      </div>

      {/* Content Layer - z-10 ensures it's above the particles */}
